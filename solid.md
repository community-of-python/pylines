...
Принципы SOLID на нашей практике показывают себя хорошо (т.е. мы для себя это обосновали эмпирически — т.е. мы их применяли и на наш взгляд показали пользу):
...
**Как вычислять нарушения**: искать претенденты для обобщения — однообразный код и цепочки if-ов.
